...
//    public static List<PathPosition> makeSphere(final PathPosition center, final double radius) {
//        final World world = BukkitMapper.toLocation(center).getWorld();
//        final List<PathPosition> sphereBlocks = new ArrayList<>();
//
//        int centerX = center.getBlockX();
//        int centerY = center.getBlockY();
//        int centerZ = center.getBlockZ();
...
//                for (int z = centerZ - (int) radius; z <= centerZ + radius; z++) {
//                    if (isInSphere(centerX, centerY, centerZ, x, y, z, radius)) {
//                        sphereBlocks.add(BukkitMapper.toPathPosition(new Location(world, x, y, z)));
//                    }
//                }
//            }
//        }
